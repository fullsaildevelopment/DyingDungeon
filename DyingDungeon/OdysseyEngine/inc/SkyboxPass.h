...
namespace Odyssey
{
	...
	{
	public:
		SkyboxPass(std::shared_ptr<RenderDevice> renderDevice, Microsoft::WRL::ComPtr<ID3D11DeviceContext> context, const char* skyboxTexture, std::shared_ptr<RenderWindow> renderWindow);
