...
//	}
//
//	std::shared_ptr<DepthState> RenderDevice::createDepthState(bool depthWriteEnable, bool depthReadEnable, ComparisonFunc comparisonFunc)
//	{
//		std::shared_ptr<DepthState> depthState = std::make_shared<DepthState>(shared_from_this(), depthWriteEnable, depthReadEnable, comparisonFunc);
//		return depthState;
//	}
//
//	std::shared_ptr<BlendState> RenderDevice::createBlendState(BlendDesc& blendDesc, float blendFactor[4])
//	{
//		std::shared_ptr<BlendState> blendState = std::make_shared<BlendState>(shared_from_this(), blendDesc, blendFactor);
//		return blendState;
//	}
//
